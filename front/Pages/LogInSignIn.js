    ...
    <View style={css.container}>
      <View style={css.box}>
          ...
          <TextInput
            ...
            <Text style={{marginTop:40,textAlign:"left",fontSize:20,fontWeight:'bold',marginLeft:35,marginBottom:8}}>Password</Text>
            {/** ---------------------------------------------------PASSWORD INPUT -----------------------------------------------*/}
...
<Image source={eye} style={{width:30,height:30,position:'absolute',marginLeft:299,marginTop:40}} />
          ...
          <Text style={{marginTop:40,textAlign:"center",fontSize:17,fontWeight:'400'}} onPress={()=>Navigation.navigate("Create an account")}>Don't have an account, sign in </Text>
