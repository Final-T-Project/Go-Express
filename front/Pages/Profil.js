...
// #373E5A khrawi
// #F2F2F2
import { TextArea, Box, Center, NativeBaseProvider,extendTheme, InputRightAddon, VStack, HStack } from "native-base";
...
function Info({navigation}) {
  ...
  <HStack>
        ...
        <Center>
        <Box marginLeft={0} height={150} top={1} size={250} width={350} borderColor={ "#F14E24"  } p="5" rounded="8"  borderWidth="2" >
        <VStack>
          <HStack marginTop={5}>
          <Image
              source={{
          ...
          <HStack marginTop={5} >
             ...
             style={{ width: 22, height: 22 , marginRight:20 }}
           ></Image>
                <Text fontSize="md"   color="#1C2765" colorScheme="darkBlue"  variant="solid" rounded="4"> 
...
function Feedback({ Product }) {
  ...
  return (
    <View style={{
      ...
      >
          ...
          <NativeBaseProvider>
               <Box alignItems="center" >
                <TextArea h={130} size="xl" placeholder="Feedback Placeholder" w="800" maxW="300"  backgroundColor={"#fafafa"} borderColor={"#ED5C00"} 
      ...
      color={"#ED5C00"}
        title="Send"
        onPress={() => Alert.alert('Your Feedback was send we will take it into considiretion.')}
      ...
      <View >
        <ScrollView>
          <View>
              ...
              source={{uri:"https://res.cloudinary.com/dn9qfvg2p/image/upload/v1673038894/background_profil_wxppqf.png"}}
              >
                </Image>
          </View>
                <View > 
                <View>
                 <Image
                source={{uri:"https://res.cloudinary.com/dn9qfvg2p/image/upload/v1671027251/tenue-classe-pour-homme_qvxxka.jpg"}}
                style={{
                    width: 100,
                    height: 100,
                    // borderRadius: 100,
